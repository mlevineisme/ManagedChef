...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "goaliepride-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/levine"
  #   chef.validation_client_name = "levine-validator"
  #   chef.validation_key_path = ".chef/levine-validator.pem"
  # end
end
